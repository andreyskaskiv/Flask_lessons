...
"""
вспомогательный класс UserMixin, который по умолчанию реализует методы: 
is_authenticated, is_active, is_anonymous и, потому, наш класс UserLogin можно записать в несколько более кратком виде:
"""
